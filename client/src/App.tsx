      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <main className="flex-1 p-8 pt-24 lg:pt-8 lg:pl-24 overflow-y-auto">
          <div className="relative mb-8 text-center flex flex-col items-center">
            ...
            <h1 className="text-4xl font-bold mb-2 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-sky-300 drop-shadow-sm">E-Commerce Sales Analytics</h1>
            {isDashboard && (
