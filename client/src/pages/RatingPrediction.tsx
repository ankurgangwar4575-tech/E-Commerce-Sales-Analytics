            ...
            {result !== null ? (
              <div className="text-center animate-in fade-in zoom-in duration-300">
                <div className="w-24 h-24 rounded-full bg-accent-teal/10 flex items-center justify-center mx-auto mb-6">
                  <Star className="w-12 h-12 text-indigo-400 fill-accent-teal" />
                </div>
                <h3 className="text-xl font-medium text-zinc-400 mb-2">Predicted Rating</h3>
                <div className="text-5xl font-bold text-white mb-2">
                  {result.toFixed(1)} <span className="text-2xl text-zinc-400">/ 5.0</span>
                </div>
                    ...
                    <Star
                      ...
                      className={`w-8 h-8 ${
                        star <= Math.round(result)
                          ? 'text-indigo-400 fill-accent-teal'
