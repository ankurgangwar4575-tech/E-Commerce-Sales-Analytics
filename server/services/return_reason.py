...
METADATA_PATH = MODEL_DIR / "return_reason_classifier_v1_metadata.json"

class ReturnReasonService:
    def __init__(self):
        if not MODEL_PATH.exists():
            raise FileNotFoundError("Return Reason Classifier model not found")
    ...
    def predict(self, data: dict) -> dict:
        ...
        return {
            "predicted_reason": results[0]["reason"],
